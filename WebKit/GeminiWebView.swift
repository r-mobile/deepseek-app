...
struct GeminiWebView: NSViewRepresentable {
    ...
    class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate, WKDownloadDelegate {
        ...
        private func isExternalURL(_ url: URL) -> Bool {
            ...
            // Only DeepSeek-related domains stay in the app
            let internalHosts = ["chat.deepseek.com", "www.deepseek.com", "deepseek.com"]
            let internalSuffixes = [".deepseek.com"]
...
extension GeminiWebView {
    ...
    struct Constants {
        ...
        static let trustedHost = "deepseek.com"
    }
