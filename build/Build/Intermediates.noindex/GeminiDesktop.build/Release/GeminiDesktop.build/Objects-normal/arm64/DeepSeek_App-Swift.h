...
#ifndef DEEPSEEK_APP_SWIFT_H
#define DEEPSEEK_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DeepSeek_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12DeepSeek_App11AppDelegate")
...
SWIFT_CLASS("_TtC12DeepSeek_App12ChatBarPanel")
@interface ChatBarPanel : NSPanel <NSWindowDelegate>
...
SWIFT_CLASS("_TtC12DeepSeek_App17ConsoleLogHandler")
@interface ConsoleLogHandler : NSObject <WKScriptMessageHandler>
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSCoder;
SWIFT_CLASS("_TtC12DeepSeek_App16WebViewContainer")
